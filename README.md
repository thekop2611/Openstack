# Openstack
Mục lục
I. Giới thiệu tổng quan về chức năng và lợi ích khi sử dụng keystone

1. 3 chức năng chính của keystone

1.1 Identity
1.2 Authentication
1.3 Access Management (Authorization)
2. Các lợi ích chính khi sử dụng keystone

II. Keystone Concepts
...
5. Use Cases for Identity Backends
III. Authentication

1. Password
2. Token
IV. Access Management and Authorization

V. Backends and Services
