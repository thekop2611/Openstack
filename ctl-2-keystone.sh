...
keystone_config () {
	...
	crudini --set $keystonefile connection mysql+pymysql://keystone:$KEYSTONE_DBPASS@$CTL_EXT_IP/keystone
	crudini --set $keystonefile provider = fernet
    crudini --set $keystonefile memcache_servers = $CTL_EXT_IP:11211
}
