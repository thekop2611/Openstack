...
nova_config () {
	...
	ops_add $novafile DEFAULT state_path /var/lib/nova
	...
	ops_add $novafile oslo_concurrency lock_path /var/log/nova/tmp
		
	ops_add $novafile DEFAULT log_dir /var/log/nova
