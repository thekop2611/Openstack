...
neutron_config_lb () {
	...
	ops_add $lbfile securitygroup enable_security_group True
	ops_add $lbfile securitygroup firewall_driver iptables
    ops_add $lbfile securitygroup enable_ipset True
...
neutron_config_metadata () {
    ...
    ops_add $metadatafile DEFAULT memcache_servers $HOST_CTL:11211
}
